...
// for progress demonstration only
...
//displays the user's entered parameters
void Sensor::showInfo(){
	cout << "SENSOR " << name << ":\t Sampling Time: " << sampleTime << endl;
	cout << "\t\t\t Floating Precision: " << precisionBits << endl << endl;
}

//generates the year.month.date.time
...
void Sensor::generateSamples(unsigned int totalSamples){
	...
	cout <<  "Generating " << totalSamples << " simulated samples....." << endl;
